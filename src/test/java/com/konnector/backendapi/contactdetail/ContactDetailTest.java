...
public class ContactDetailTest {
	...
	@Test
	public void validateForCreation_nameIsNull_throwsException() {
		contactDetail.setName(null);
		assertThrows(InvalidDataException.class, () -> contactDetail.validateForCreation());
	}

	@Test
	public void validateForCreation_nameIsEmpty_throwsException() {
		contactDetail.setName("");
		assertThrows(InvalidDataException.class, () -> contactDetail.validateForCreation());
	}
	...
	@Test
	public void validateForUpdate_nameIsNull_throwsException() {
		contactDetail.setName(null);
		assertThrows(InvalidDataException.class, () -> contactDetail.validateForUpdate());
	}

	@Test
	public void validateForUpdate_nameIsEmpty_throwsException() {
		contactDetail.setName("");
		assertThrows(InvalidDataException.class, () -> contactDetail.validateForUpdate());
	}
	...
	public void merge_merges() {
		...
		assertEquals(contactDetail1.getName(), contactDetail2.getName());
